...
_UNKNOWN_CMD_SKIP = {
    "INTERACT_WORD", "ENTRY_EFFECT", "ONLINE_RANK_COUNT", "ONLINE_RANK_V2",
    "ONLINE_RANK_TOP3", "STOP_LIVE_ROOM_LIST", "WATCHED_CHANGE", "LIKE_INFO_V3_CLICK",
    ...
    "PK_BATTLE_PRE_NEW", "PK_BATTLE_PRE", "PK_BATTLE_START", "PK_BATTLE_MATCH_TIMEOUT",
    "RECOMMEND_CARD", "TRADING_SCORE", "GIFT_STAR_PROCESS",
    ...
    "SUPER_CHAT_ENTRANCE", "DANMU_AGGREGATION",
}
